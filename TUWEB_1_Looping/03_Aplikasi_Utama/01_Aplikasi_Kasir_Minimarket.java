...
public class AplikasiKasirMinimarket {
    ...
    public static void main(String[] args) {
        ...
        String[] pembelianProduk = new String[100];
        int[] pembelianHarga = new int[100];
        int[] pembelianJumlah = new int[100];
        int[] pembelianSubtotal = new int[100];
        ...
        while (lanjut == 'y' || lanjut == 'Y') {
            ...
            pembelianProduk[jumlahPembelian] = namaProduk[index];
            pembelianHarga[jumlahPembelian] = hargaProduk[index];
            pembelianJumlah[jumlahPembelian] = jumlah;
            pembelianSubtotal[jumlahPembelian] = subtotal;
            jumlahPembelian++;
        ...
        if (totalHarga > 0) {
            ...
            // Tampilkan struk lengkap
            System.out.println("\nSTRUK PEMBELIAN:");
            System.out.println("=================================");
            System.out.println("MINIMARKET SEDERHANA");
            System.out.println("Tanggal: " + java.time.LocalDate.now());
            System.out.println("Waktu  : " + java.time.LocalTime.now().getHour() + ":" + java.time.LocalTime.now().getMinute());
            System.out.println("=================================");
            System.out.println("No.  Produk         Harga    Jumlah   Subtotal");
            System.out.println("--------------------------------------------");
            
            // Tampilkan detail pembelian menggunakan for loop
            for (int i = 0; i < jumlahPembelian; i++) {
                System.out.printf("%-4d %-15s %-8d %-8d %-8d%n", 
                    (i + 1), 
                    pembelianProduk[i], 
                    pembelianHarga[i], 
                    pembelianJumlah[i], 
